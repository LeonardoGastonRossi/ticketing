...
// we can improve that and put it in env variables
...
router.post(
  ...
  [
    body('ticketId')
      .not()
      .isEmpty()
      // we shouldn't put this validation because we are asumming that ticketId comes from another system that use mongo db to store stickets
